...
function loadAlbumItem(album) {
    var nameHtml = '<a class="btn btn-default" style="width:48%;margin:1%;overflow:hidden;color:black" href=# album-id="' + album.Id + '">' + album.Name + '</a>';
    var editHtml = '<a class="btn btn-default" style="width:23%;margin:1%;overflow:hidden;color:black" href=# edit-id = "' + album.Id + '">Edit</a>';
    var delHtml = '<a class="btn btn-default" style="width:23%;margin:1%;overflow:hidden;color:black" href=# delete-id = "' + album.Id + '">Delete</a>';
...
function loadAlbum(album) {
    ...
    $.ajax({
        ...
        $("li[album-row]").css("background-color", "lightgray");
